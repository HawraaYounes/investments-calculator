...
This project is an investments calculator built using ReactJS and Vite. It aims to practice my skills in frontend development, particularly in creating dynamic user interfaces and managing state in React.
...
- **Deployed Version**: The project is deployed and accessible online. [Click here to view the deployed version](https://investments-calculator-sigma.vercel.app/).
...
1. Clone the repository: `git clone https://github.com/HawraaYounes/investments-calculator.git`
2. Navigate to the project directory: `cd investments-calculator`
